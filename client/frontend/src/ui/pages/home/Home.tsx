  ...
  return (
    <>
      ...
      {homepageinfo && headerData && (
        <Header logo={headerData[0].name} navlink1={rename(headerData[1].name)} navlink2={rename(headerData[2].name)} navlink3={rename(headerData[3].name)}buttontext={rename(headerData[4].name)} />
      )}
